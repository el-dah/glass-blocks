...
animate();
window.setTimeout(takeScreenshot, 60000)


function takeScreenshot(){
    const canvas = document.getElementById('myCanvas'); // Replace 'myCanvas' with your canvas's ID
    const imageDataURL = canvas.toDataURL('image/png'); // Or 'image/jpeg' for JPEG format
    const link = document.createElement('a');
    link.download = 'canvas-screenshot.png'; // Specify filename and extension
